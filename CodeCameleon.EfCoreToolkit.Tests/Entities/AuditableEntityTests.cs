...
/// <summary>
/// The test fixture for all <see cref="AuditableEntity" /> related tests.
/// </summary>
internal class AuditableEntityTests
    : BaseEntityTestFixture<AuditableEntity, TestAuditableEntity>
{
    /// <summary>
    /// Verifies whether <see cref="AuditableEntity" /> correctly implements
